...
history = model.fit(np.array(X_tr), y_tr, validation_data=(np.array(X_val), y_val), batch_size=batch_size, epochs=4, verbose=1)
...
#50
test_pred = model.predict(np.array(X_te), verbose=1,batch_size=32)
